...
| 4b | factory | v0.12.0 | released (`707c01a`, tag `a5e5c02`) |
| 5 | wui | v0.4.0 | released (`f993ff6`, tag `8e5d63d`) |
| 6 | tests | v0.14.0 | released (`2496241`, tag `ff51093`); principal/metadata and presenter lanes pass |
| 7 | carbon, Oxy | carbon v0.30.0; Oxy pending | Carbon released (`93020ff`, tag `3f7dfb4`); Oxy Phases 4–8 remain |
