...
- **Cross-module wiring during development:** the new modules are unpublished. Use
  ...
  `replace github.com/looprig/storage => ../ciram-co/storekit`) and re-vendor
...
**Step 2:** Add to go.mod: `require github.com/looprig/storage v0.0.0` +
`replace github.com/looprig/storage => ../ciram-co/storekit`. Run
...
`github.com/looprig/storage — leaf storage contracts (Ledger/Leaser/KV/Blobs) +
...
go 1.25.0, `require github.com/looprig/storage` + `replace => ../storekit`, CLAUDE.md
...
2. looprig: remove the `replace`, `require github.com/looprig/storage v0.1.0`,
