...
- `golang.org/x/sys/windows` — typed Windows security-descriptor, DACL, and filesystem APIs used to create and validate owner-only durable session-resource storage; the Go standard library does not expose these ACL primitives. **Approved 2026-07-28.**
