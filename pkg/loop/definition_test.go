...
func TestDefineValidation(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "adapter engine requires runtime profile", opts: []Option{WithName("a"), WithInference(&fakeLLM{}, testModel()), WithEngine(EngineAdapter)}, kind: DefinitionInvalidEngine},
