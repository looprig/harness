// pkg/llm/codec/anthropicapi/encode.go
...
// EncodeRequest converts a provider-neutral llm.Request into an Anthropic
...
func buildMessagesRequest(req llm.Request, stream bool) (messagesRequest, error) {
...
// effortValue maps the dialect-neutral llm.Effort to Anthropic's
...
func effortValue(e llm.Effort) string {
	switch e {
	case llm.EffortLow:
		return "low"
