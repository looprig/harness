...
func TestEventClass(t *testing.T) {
	...
	tests := []struct {
		...
		{"PermissionReviewStarted enduring", event.PermissionReviewStarted{}, event.Enduring},
		{"PermissionReviewCompleted enduring", event.PermissionReviewCompleted{}, event.Enduring},
		{"ProcessStarted enduring", event.ProcessStarted{}, event.Enduring},
		{"ProcessBackgrounded enduring", event.ProcessBackgrounded{}, event.Enduring},
		{"ProcessCompleted enduring", event.ProcessCompleted{}, event.Enduring},
		{"ProcessStopRequested enduring", event.ProcessStopRequested{}, event.Enduring},
		{"ProcessLost enduring", event.ProcessLost{}, event.Enduring},
		...
		{"DelegateDeliveryStateChanged enduring", event.DelegateDeliveryStateChanged{}, event.Enduring},
		...
		{"CompactionStarted ephemeral", event.CompactionStarted{}, event.Ephemeral},
		{"CompactionCommitted enduring", event.CompactionCommitted{}, event.Enduring},
		{"CompactionRejected enduring", event.CompactionRejected{}, event.Enduring},
		{"CompactWaiterResolved enduring", event.CompactWaiterResolved{}, event.Enduring},
		{"CompactWaiterRejected enduring", event.CompactWaiterRejected{}, event.Enduring},
...
func TestEventEndsTurn(t *testing.T) {
	...
	tests := []struct {
		...
		{"PermissionReviewStarted does not end turn", event.PermissionReviewStarted{}, false},
		{"PermissionReviewCompleted does not end turn", event.PermissionReviewCompleted{}, false},
		{"ProcessStarted does not end turn", event.ProcessStarted{}, false},
		{"ProcessBackgrounded does not end turn", event.ProcessBackgrounded{}, false},
		{"ProcessCompleted does not end turn", event.ProcessCompleted{}, false},
		{"ProcessStopRequested does not end turn", event.ProcessStopRequested{}, false},
		{"ProcessLost does not end turn", event.ProcessLost{}, false},
		...
		{"DelegateDeliveryStateChanged does not end turn", event.DelegateDeliveryStateChanged{}, false},
		...
		{"CompactionStarted does not end turn", event.CompactionStarted{}, false},
		{"CompactionCommitted does not end turn", event.CompactionCommitted{}, false},
		{"CompactionRejected does not end turn", event.CompactionRejected{}, false},
		{"CompactWaiterResolved does not end turn", event.CompactWaiterResolved{}, false},
		{"CompactWaiterRejected does not end turn", event.CompactWaiterRejected{}, false},
...
func TestEventScope(t *testing.T) {
	...
	tests := []struct {
		...
		{"DelegateDeliveryStateChanged session-scoped", event.DelegateDeliveryStateChanged{}, event.ScopeSession},
		{"ProcessStarted loop-scoped", event.ProcessStarted{}, event.ScopeLoop},
		{"ProcessBackgrounded loop-scoped", event.ProcessBackgrounded{}, event.ScopeLoop},
		{"ProcessCompleted loop-scoped", event.ProcessCompleted{}, event.ScopeLoop},
		{"ProcessStopRequested loop-scoped", event.ProcessStopRequested{}, event.ScopeLoop},
		{"ProcessLost loop-scoped", event.ProcessLost{}, event.ScopeLoop},
		...
		{"CompactionStarted loop-scoped", event.CompactionStarted{}, event.ScopeLoop},
		{"CompactionCommitted loop-scoped", event.CompactionCommitted{}, event.ScopeLoop},
		{"CompactionRejected loop-scoped", event.CompactionRejected{}, event.ScopeLoop},
		{"CompactWaiterResolved loop-scoped", event.CompactWaiterResolved{}, event.ScopeLoop},
		{"CompactWaiterRejected loop-scoped", event.CompactWaiterRejected{}, event.ScopeLoop},
		...
		{"PermissionReviewStarted loop-scoped", event.PermissionReviewStarted{}, event.ScopeLoop},
		{"PermissionReviewCompleted loop-scoped", event.PermissionReviewCompleted{}, event.ScopeLoop},
